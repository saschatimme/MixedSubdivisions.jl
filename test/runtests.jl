...
@testset "TropicalHomotopyContinuation" begin
    ...
    cell = MixedCell(mixed_cell_indices, C, indexing)
    @test cell.volume == 3
    ...
    @test THC.exchange_column(cell, THC.exchange_first, ineq) == MixedCell([(4, 3), (1, 3)], C, indexing)
    @test THC.exchange_column(cell, THC.exchange_second, ineq) == MixedCell([(2, 4), (1, 3)], C, indexing)
